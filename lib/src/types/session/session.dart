...
class PacketSessionData {
  ...
  // 5 = Medium Long, 6 = Long, 7 = Full
  final int m_gameMode;

  // Ruleset - see appendix
  final int m_ruleSet;

  // Local time of day - minutes since midnight
  final int m_timeOfDay;
  // 0 = None, 2 = Very Short, 3 = Short, 4 = Medium
  // 5 = Medium Long, 6 = Long, 7 = Full
  final int m_sessionLength;
  ...
  PacketSessionData({
    ...
    required this.m_gameMode,
    required this.m_ruleSet,
    required this.m_timeOfDay,
    required this.m_sessionLength,
  });
}
